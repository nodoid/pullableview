...
void *
native_to_managed_trampoline_pullableview_AppDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_AppDelegate_FinishedLaunching (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_4, 1));
		}
		arg_ptrs [1] = mobj1;
...
void *
native_to_managed_trampoline_pullableview_AppDelegate_DidEnterBackground (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_AppDelegate_WillEnterForeground (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_AppDelegate_OnActivated (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_AppDelegate_WillTerminate (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_PullableView__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_PullableView_HandleDrag (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_PullableView_HandleTap (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_PullableView_AnimationDidStopFinishedContext (id this, SEL sel, NSString * p0, bool p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_ViewController_DidReceiveMemoryWarning (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_pullableview_ViewController_ViewDidLoad (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
static MTClassMap __monotouch_class_map [] = {
	...
	{"AppDelegate", "pullableview.AppDelegate, pullableview", 0},
	...
	{"pullableview.PullableView", "pullableview.PullableView, pullableview", 0},
	{"pullableview.ViewController", "pullableview.ViewController, pullableview", 0},
	{"UIWindow", "MonoTouch.UIKit.UIWindow, monotouch", 0},
	{"pullableview.StyledPullableView", "pullableview.StyledPullableView, pullableview", 0},
};
...
static MTClass __monotouch_classes [] = {
	...
	{"pullableview.PullableView", "UIView", 1, 4, 0},
	{"pullableview.ViewController", "UIViewController", 1, 2, 0},
	{"pullableview.StyledPullableView", "pullableview.PullableView", 1, 0, 0},
};
...
static MTMethod __monotouch_methods [] = {
	...
	{"init","@@:",0, &native_to_managed_trampoline_pullableview_AppDelegate__ctor},
	{"application:didFinishLaunchingWithOptions:","B@:@@",0, &native_to_managed_trampoline_pullableview_AppDelegate_FinishedLaunching},
	{"applicationDidEnterBackground:","v@:@",0, &native_to_managed_trampoline_pullableview_AppDelegate_DidEnterBackground},
	{"applicationWillEnterForeground:","v@:@",0, &native_to_managed_trampoline_pullableview_AppDelegate_WillEnterForeground},
	{"applicationDidBecomeActive:","v@:@",0, &native_to_managed_trampoline_pullableview_AppDelegate_OnActivated},
	{"applicationWillTerminate:","v@:@",0, &native_to_managed_trampoline_pullableview_AppDelegate_WillTerminate},
	{"init","@@:",0, &native_to_managed_trampoline_pullableview_PullableView__ctor},
	{"handleDrag","v@:@",0, &native_to_managed_trampoline_pullableview_PullableView_HandleDrag},
	{"handleTap","v@:@",0, &native_to_managed_trampoline_pullableview_PullableView_HandleTap},
	{"animationDidStop","v@:@B",0, &native_to_managed_trampoline_pullableview_PullableView_AnimationDidStopFinishedContext},
	{"didReceiveMemoryWarning","v@:",0, &native_to_managed_trampoline_pullableview_ViewController_DidReceiveMemoryWarning},
	{"viewDidLoad","v@:",0, &native_to_managed_trampoline_pullableview_ViewController_ViewDidLoad},
};

static MTProperty __monotouch_properties [] = {
};

int __monotouch_map_count = 30;
